...
export function seedAll(): void {
  // Demo password used across seeded accounts: "spa-demo-2026"
  ...
  const services: Service[] = [
    {
      ...
      description:
        "Long, gliding strokes that ease tension and improve circulation.",
      long_description:
    ...
    },
    {
      ...
      description:
        "Focused pressure to release chronic tension in deeper muscle layers.",
      long_description:
    ...
    },
    {
      ...
      description:
        "Side-lying support for the second and third trimesters.",
      long_description:
    ...
    },
    {
      ...
      description:
        "Smooth basalt stones placed along energy points for deep release.",
      long_description:
    ...
    },
    {
      ...
      description:
        "Custom essential oil blend chosen for your nervous system that day.",
      long_description:
    ...
    },
    {
      ...
      description:
        "8-hour continuing education course for licensed massage therapists.",
      long_description:
  ...
  // Availability — Tue–Sat, 9am–6pm for each provider
  const providers = [
    FIXED_IDS.marcus,
    FIXED_IDS.jasmine,
    FIXED_IDS.rosa,
  ...
  // Products — Essentially Yours line
  const products: Product[] = [
    ...
    },
    {
      ...
      description:
        "Lavender oil, Deep Rest balm, and Twilight candle in a kraft box.",
      long_description:
